import C1 from "../assets/images/mahirprogramming.png";
import C2 from "../assets/images/BelajarBersama.png";
    ...
    return (
        <div className="w-full h-auto flex flex-col">
            <div className="w-full h-auto flex flex-row bg-white p-[10px] mb-3 gap-[20px]">
                <img src={C1} alt="Foto" className="w-[310px] h-auto rounded-[10px]" />
                <div className="flex flex-col items-start justify-center">
                    ...
                    <div className="flex flex-row justify-center items-center gap-5 mt-2">
                        ...
                        <p>10 Online . 52 Anggota</p>
                    </div>
                </div>
            </div>

            <div className="w-full h-auto flex flex-row bg-white p-[10px] mb-3 gap-[20px]">
                <img src={C2} alt="Foto" className="w-[310px] h-auto rounded-[10px]" />
                <div className="flex flex-col items-start justify-center">
                    <div className="flex flex-row justify-center items-center gap-5">
                        <img src={TN} alt="" className="w-[58px] h-auto rounded-[20px]" />
            ...
            <div className="w-full h-auto flex flex-row bg-white p-[10px] mb-3 gap-[20px]">
                <img src={C3} alt="Foto" className="w-[310px] h-auto rounded-[10px]" />
                <div className="flex flex-col items-start justify-center">
                    <div className="flex flex-row justify-center items-center gap-5">
                        <img src={TN} alt="" className="w-[58px] h-auto rounded-[20px]" />
                        <h1 className="font-bold text-[24px] ">Belajar Bersama</h1>
            ...
            <div className="w-full h-auto flex flex-row bg-white p-[10px] mb-3 gap-[20px]">
                <img src={C4} alt="Foto" className="w-[310px] h-auto rounded-[10px]" />
                <div className="flex flex-col items-start justify-center">
                    <div className="flex flex-row justify-center items-center gap-5">
                        <img src={TN} alt="" className="w-[58px] h-auto rounded-[20px]" />
